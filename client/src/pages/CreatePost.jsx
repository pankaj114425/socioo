         ...
         {/* form */}
          ...
          space-y-4'>
                ...
                <div className='flex items-center gap-3'>
                  <img src={user.profile_picture} alt="" className='h-12 w-12
                  rounded-full shadow' />
                  <div>
                ...
                {/* textarea */}
                <textarea  onChange={(e)=>setContent(e.target.value)} value={content} className='w-full resize-none max-h-20 mt-4 text-sm outline-none
                placeholder-gray-400' placeholder="What's you  happening?"/>
                {/* images */}
                {
                  images.length >0 && <div className='flex flex-wrap gap-2 mt-4'>
                    {images.map((image,i)=>(
                       <div key={i} className='relative group'>
                        ...
                        !== i))} className='absolute hidden group-hover:flex justify-center items-center
