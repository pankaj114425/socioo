                   ...
                   <div className='flex flex-col items-start gap-3'>
                    ...
                    font-medium text-gray-700 mb-1'>
                        ...
                        <div className='group/profile relative'>
                            ...
                            (editForm.profile_picture) :user.profile_picture} alt="" 
                    ...
                    <div>
                      ...
                      mb-1'>
                        ...
                        border-gray-200 rounded-lg' placeholder='please
                        enter your full name' onChange={(e)=>
                     ...
                     <div>
                      ...
                      mb-1'>
                        Bio
                        <textarea rows={3}  className='w-full p-3 border 
                        border-gray-200 rounded-lg' placeholder='please enter your bio' onChange={(e)=>
                     ...
                     <div>
                      ...
                      mb-1'>
                        ...
                        <input type="text"  className='w-full p-3 border 
                        border-gray-200 rounded-lg' placeholder='please
                        enter your loaction' onChange={(e)=>
                        setEditForm({...editForm,location:e.target.value})} value={editForm.location}/>
                      </label>
                    </div>

                    <div className='flex justify-end space-x-3 pt-6'>
                       <button onClick={()=>setShowEdit(false)} type='button' className='px-4 border py-2 border-gray-300
                       rounded-lg text-white bg-red-500 hover:bg-red-700  transition-colors cursor-pointer'>Cancel</button>
