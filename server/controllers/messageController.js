...
// create a empty object to store server side event coonections
...
//    set server side header 
res.setHeader('Content-Type','text/event-strean');
res.setHeader('Cache-Control','no-cache');
res.setHeader('Connection','keep-alive');
res.setHeader('Access-Control-Allow-Origin','*');

//add the client response object to connections object
...
export const sendMessage=async(req,res)=>{
    try {
        ...
        //send message to touserid server side event
